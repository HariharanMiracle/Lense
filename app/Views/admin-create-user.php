...
<br/>
    <form action="<?php echo base_url('User/store0');?>" name="user_create" id="user_create" method="post" accept-charset="utf-8" onsubmit="return validateForm()">
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label for="username">Username &nbsp; <span style="color:red;"><?php echo $userErrMsg; ?></span></label>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="checkbox" onclick="f_re_pasword()"> &nbsp; Show Current Password
                    </div>
                </div>
            </div>
