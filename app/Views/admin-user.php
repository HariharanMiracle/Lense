...
<!-- All Categories -->
            <div class="row">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo base_url().'/User/create0'; ?>" class="btn btn-orange" alt="Create Category">Add New</a>
                        </div>
                    </div>
                    <br />
                                        ...
                                        echo '<tbody>';
                                            ...
                                            foreach ($user as $obj) {
                                                ...
                                                echo '<tr>';
                                                    ...
                                                    echo '<td><a class="a-orange" href="'.base_url().'/User/edit0/'.$obj['id'].'" alt="Edit Category - '.$obj['username'].'"><i class="far fa-edit"></i></a></td>';
