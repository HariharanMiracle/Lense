...
#grad1 {
  ...
  background-image: linear-gradient(to right, #9b75eb, #7577eb, #75a0eb); /* Standard syntax (must be last) */
}
    ...
    <div class="container h-100">
        <div class="card bg-transparent mt-5">
            <div style="width:80%; margin-left:10%;">
            	<form action="<?php echo base_url('Login/product');?>" name="login" id="login" method="post" accept-charset="utf-8">
                    <div class="text-center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="checkbox" onclick="f_pasword()"> &nbsp; Show Password
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-secondary btn-login">Login</button>
                            <a href="<?php echo base_url('Home'); ?>"><input class="btn btn-primary" type = "button" value = "Home" name = "Home"/></a>
                        </div>
                        <div>
    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4 align-middle">
            <div class="card login-form text-center">
                ...
                <form action="<?php echo base_url('Login/product'); ?>" name="login" id="login" method="post"
